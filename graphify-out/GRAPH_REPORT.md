...
## Corpus Check
- 65 files · ~3,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 249 nodes · 230 edges · 51 communities (22 shown, 29 thin omitted)
...
Cohesion: 0.17
Nodes (10): conversations, sources, HealthBadge(), getHealth(), ChatRequest, ChatResponse, Confidence, HealthResponse (+2 more)
